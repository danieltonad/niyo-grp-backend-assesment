...
async def add_user_tasks_route(task: TaskModel, background_task: BackgroundTasks, user: str = Depends(decode_access_token)):
...
async def update_user_tasks_route(id: str, task: UpdateTaskModel, background_task: BackgroundTasks, user: str = Depends(decode_access_token)) -> bool:
...
async def delete_user_tasks_route(id: str, background_task: BackgroundTasks, user: str = Depends(decode_access_token)):
